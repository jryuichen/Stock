...
namespace PolyAndCode.UI
{
    ...
    public class HorizontalRecyclingSystem : RecyclingSystem
    {
        ...
        public void OnDrawGizmos()
        {
            ...
            Gizmos.DrawLine(_recyclableViewBounds.min - new Vector3(0, 2000),
                _recyclableViewBounds.min + new Vector3(0, 2000));
            Gizmos.color = Color.red;
            Gizmos.DrawLine(_recyclableViewBounds.max - new Vector3(0, 2000),
                _recyclableViewBounds.max + new Vector3(0, 2000));
        }
        ...
        public HorizontalRecyclingSystem(RectTransform prototypeCell, RectTransform viewport, RectTransform content,
            IRecyclableScrollRectDataSource dataSource, bool isGrid, int rows)
        {
        ...
        private void SetRecyclingBounds()
        {
            ...
            var threshHold = RecyclingThreshold * (_corners[2].x - _corners[0].x);
        ...
        private void CreateCellPool()
        {
            ...
            var requriedCoverage = MinPoolCoverage * Viewport.rect.width;
            ...
            if (IsGrid) _RightMostCellRow = (_RightMostCellRow - 1 + _rows) % _rows;
        ...
        public override Vector2 OnValueChangedListener(Vector2 direction)
        {
            ...
            if (direction.x < 0 && _cellPool[rightMostCellIndex] != null &&
                _cellPool[rightMostCellIndex].MinX() < _recyclableViewBounds.max.x)
                return RecycleLeftToRight();
            if (direction.x > 0 && _cellPool[leftMostCellIndex] != null &&
                _cellPool[leftMostCellIndex].MaxX() > _recyclableViewBounds.min.x)
        ...
        private Vector2 RecycleLeftToRight()
        {
            ...
            var n = 0;
            var posX = IsGrid ? _cellPool[rightMostCellIndex].anchoredPosition.x : 0;
            float posY = 0;
                   ...
                   currentItemCount < DataSource.GetItemCount())
            {
                ...
                else
                {
                    ...
                    _cellPool[leftMostCellIndex].anchoredPosition =
                        new Vector2(posX, _cellPool[leftMostCellIndex].anchoredPosition.y);
                }
            ...
            if (IsGrid)
            {
                ...
                if (additionalColoums > 0) n -= additionalColoums;
            }
        ...
        private Vector2 RecycleRightToleft()
        {
            ...
            var n = 0;
            var posX = IsGrid ? _cellPool[leftMostCellIndex].anchoredPosition.x : 0;
            float posY = 0;
                   ...
                   currentItemCount > _cellPool.Count)
            {
                ...
                else
                {
                    ...
                    _cellPool[rightMostCellIndex].anchoredPosition =
                        new Vector2(posX, _cellPool[rightMostCellIndex].anchoredPosition.y);
                    n++;
                }
